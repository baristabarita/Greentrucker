    ...
    return (
        <div className="animate-fade-in font-poppings bg-primarycolor text-darkblue">
            ...
            {!businessDetails ? (
                ...
                <div className="bg-white h-[100%] px-7 py-3" style={{ backgroundImage: `url(${backgroundimg})` }}>
                    {/* View your Selection */}
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-4 mb-4">
                        ...
                        <div className="bg-white col-span-2 md:col-span-2 border rounded p-4 shadow-lg drop-shadow-xl">
                            ...
                            <div className="flex items-center mb-4">
                                <img src={businessDetails.logo || truckicon} alt="Business Logo" className="w-[30%] h-[10.5em] mr-4" />
                                <div>
            ...
            {showAlert && (
                <div className="fixed inset-0 flex items-center justify-center bg-opacity-50 bg-black backdrop-blur">
                    <div className="bg-white p-6 rounded-md shadow-md flex flex-col items-end">
                        <button onClick={() => setShowAlert(false)} className="self-end mb-4">
