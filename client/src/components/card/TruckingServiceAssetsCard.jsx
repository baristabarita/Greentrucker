// TruckingServiceAssetsCard.jsx
import React from 'react';

const TruckingServiceAssetsCard= ({ asset }) => {
  const { asset_category } = asset;

  return (
    <div className="bg-white border border-solid border-gray-400 rounded p-4 mx-3 shadow-lg">
...
export default TruckingServiceAssetsCard;
